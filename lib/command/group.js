  ...
  if (command == "setwelcome") {
    if (!query) {
      ...
      if (!database[msg.from].setwelcome == {}) {
        ...
        database[msg.from].setwelcome = JSON.stringify(objekwelcome, null, 2);
        client.reply(msg, `sukses Welcome telah di setel ulang menjai ${database[msg.from].setwelcome.body}`)
      } else {
        const objekwelcome = {
          status: true,
          group: msg.from,
        ...
        database[msg.from].setwelcome = JSON.stringify(objekwelcome, null, 2);
        client.reply(msg, `sukses Welcome telah di setel menjai ${database[msg.from].setwelcome.body}`)
      }
    }
